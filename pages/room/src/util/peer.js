class PeerBuilder{
  ...
  _prepareCallEvent(call){
    ...
    call.on('call', _ => this.onCallClose(call))

    this.onCallReceived(call)
  }

  // adicionar o comportamento dos eventos de call tambem para quem liga
  _preparePeerInstanceFunction(peerModule){
    ...
    PeerCustomModule.prototype.call = function(id, stream){
      ...
      //aqui interceptamos o call e adicionamos todos os eventos da chamada também para quem liga
